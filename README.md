...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-m2bncaw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-m2bncaw.containers.anotherwebservice.com/
...
```
git clone git@github.com:wilnguyen/container-m2bncaw.git
cd container-m2bncaw
```
...
```
docker attach container-m2bncaw
```
